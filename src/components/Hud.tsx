...
export function Hud() {
  ...
  // browser notifications for danger alerts
  useEffect(() => {
  ...
  const historyMax = useMemo(() => Date.now(), [now, history]);
        ...
        <header className="pointer-events-auto flex items-start justify-between">
          <div className="panel-glass rounded-xl px-4 py-3">
            ...
            <div className="mt-2 flex gap-6 font-mono text-sm">
              ...
              <span className="text-fg">ACTIVE {agentActiveCount}</span>
            </div>
            <div className="mt-2">
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-20 flex flex-col justify-between p-3 sm:p-5">
      ...
      <header className="pointer-events-auto relative flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="panel-glass flex flex-wrap items-center gap-2 rounded-xl px-3 py-2">
          <button
            ...
            className="inline-flex h-10 items-center gap-2 rounded-lg border border-border bg-surface-elevated px-3 text-sm text-fg hover:border-accent/40 hover:text-accent"
            title="Kiosk mode"
          >
          ...
          <button
            ...
            className={`inline-flex h-10 items-center gap-2 rounded-lg border px-3 text-sm ${
              alertsEnabled
                ? "border-border bg-surface-elevated text-fg"
                : "border-border bg-surface-elevated text-faint"
            }`}
            title="Alerts"
          >
            {alertsEnabled ? (
          ...
          <button
            ...
            className="inline-flex h-10 items-center rounded-lg border border-border bg-surface-elevated px-3 text-fg"
          >
            {soundEnabled ? (
          ...
          <button
            ...
            disabled={mode === "real"}
            className="inline-flex h-10 items-center rounded-lg border border-border bg-surface-elevated px-3 text-fg disabled:opacity-40"
          >
          ...
          {mode !== "real" && (
            <button
              ...
              className="inline-flex h-10 items-center rounded-lg border border-primary/30 bg-primary/10 px-3 text-primary"
            >
          ...
          {mode === "demo" && (
            <button
              ...
              className="inline-flex h-10 items-center rounded-lg border border-accent/30 bg-accent/10 px-3 text-accent"
            >
          ...
          <button
            type="button"
            onClick={() => clear()}
            className="inline-flex h-10 items-center rounded-lg border border-border bg-surface-elevated px-3 text-muted hover:text-danger"
          >
      ...
      <div className="pointer-events-none relative flex flex-1 items-stretch justify-between gap-3 py-3">
        <aside className="pointer-events-auto flex w-[min(100%,16.5rem)] flex-col gap-3 self-end overflow-y-auto sm:self-center">
          <div className="panel-glass rounded-xl p-3 sm:p-4">
            ...
            {topTalkers.length > 0 && (
              <div className="mt-3 border-t border-border pt-3">
                <p className="text-[10px] uppercase text-faint">Top talkers</p>
                <ul className="mt-1.5 space-y-1.5">
                  {topTalkers.slice(0, 5).map((t) => (
      ...
      <div className="pointer-events-auto relative z-10 space-y-2">
        ...
        <p className="hidden text-center text-[11px] text-faint sm:block">
          Presets · mute · focus for process/ASN · kiosk · replay scrubber
        </p>
      </div>
    </div>
  );
